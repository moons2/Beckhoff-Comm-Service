...
#define OUT_PIN_4 3 //Dig IN/Out motor 1 - PINO 4
#define OUT_PIN_5 4 //Dig In motor 2 - PINO 5
#define OUT_PIN_6 5	//Dig In motor 2 - PINO 6
#define OUT_PIN_7 6 //Dig In/Out motor 2 - PINO 7
